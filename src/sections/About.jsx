...
import aboutImg2 from "../assets/images/about_imgcheck.jpg";
...
export default function About() {
  return (
    <section
      ...
      id="about"
    >
      <div className="w-full md:w-full pl-4 lg:w-1/2 mb-8">
      ...
      <div className="w-full lg:w-1/2 space-y-4">
        <h3 className="text-4xl text-gray-900 font-bold underline mt-2">
          ABOUT US
        </h3>
        ...
        <div className="mt-12 space-y-6">
          <div className="flex items-center">
            {/* <div className="bg-gray-100 p-4 rounded-md object-cover"> */}
            <img
              src={missionImg}
              alt="Mission Icon"
